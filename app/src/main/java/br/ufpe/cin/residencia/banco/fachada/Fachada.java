...
public class Fachada {
	...
	public void cadastrar(ContaAbstrata c) throws ContaExistenteException, ClienteInexistenteException, ClienteInvalidoException {
		...
		if (cli != null && clientes.existe(cli.getCpf())) {
			contas.inserir(c);
		} else {
	...
	public void transferir(String origem, String destino, double valor) throws ContaInexistenteException, SaldoInsuficienteException {
